...
%this function returns a ray directions given intrinsic and extrinsic camera
%parameters and pixel coordinates.
...
dirs = -dirs'; %i added a negative here to fix something screwy...
