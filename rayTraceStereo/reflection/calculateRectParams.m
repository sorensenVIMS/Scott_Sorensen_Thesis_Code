...
%stereo pair to use. It is based off matlabs example found here
...
blobs1 = detectSURFFeatures(I1, 'MetricThreshold', 5);
blobs2 = detectSURFFeatures(I2, 'MetricThreshold', 5);
%extract features
...
gte = vision.GeometricTransformEstimator('PixelDistanceThreshold', 200);
